...
InertialSenseROS::InertialSenseROS() : nh_(), nh_private_("~"), initialized_(false), rtk_connectivity_watchdog_timer_()
{
 ...
 InertialSenseROS::InertialSenseROS(std::string paramYAMLPath)
 {
...
void InertialSenseROS::connect_rtk_client(const std::string &RTK_correction_protocol_, const std::string &RTK_server_IP, const int RTK_server_port)
{
...
void InertialSenseROS::start_rtk_connectivity_watchdog_timer()
{
    ...
    {
        float rtk_connectivity_watchdog_timer_frequency_;
